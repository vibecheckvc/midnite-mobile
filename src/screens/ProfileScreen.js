...
const styles = StyleSheet.create({
  ...
  bannerContainer: { width: "100%", height: 80, marginBottom: 35 }, // Increased marginBottom from 20 to 35 for even more spacing
  bannerGradient: {
    flex: 1,
    justifyContent: "center",
    alignItems: "center",
    paddingTop: 20, // Added paddingTop to center the text vertically
    paddingBottom: 20, // Reduced paddingBottom to balance the centering
    borderBottomWidth: 2,
